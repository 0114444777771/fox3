...
async def get_thumb(videoid):
    ...
    try:
        ...
        font = ImageFont.truetype("SrcMusicKERO/assets/font2.ttf", 40)
        font2 = ImageFont.truetype("SrcMusicKERO/assets/font2.ttf", 70)
        arial = ImageFont.truetype("SrcMusicKERO/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("SrcMusicKERO/assets/font.ttf", 30)
