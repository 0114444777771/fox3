...
LOGGER = logging.getLogger("ميوزك الــيكـس")

class Zelzaly(Client):
    def __init__(self):
        LOGGER.info(f"جارِ بدء تشغيل البوت . . .")
        super().__init__(
            name="SrcMusicKERO",
    ...
    async def start(self):
        ...
        try:
            ...
            LOGGER.error("» قم باضافة البـوت مشـرفـاً بكافة الصلاحيات في مجموعـة السجـل")
            exit()
        ...
        try:
            ...
            if a.status != ChatMemberStatus.ADMINISTRATOR:
                ...
                LOGGER.error("» قم برفـع البـوت مشـرفـاً بكافة الصلاحيات في مجموعـة السجـل")
                exit()
